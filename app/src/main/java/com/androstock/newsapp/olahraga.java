...
public class olahraga extends AppCompatActivity {
    ...
    String CATEGORY = "sports"; // // ### CHANGE WITH YOUR NEWS SOURCES see newsapi.org ###
    ListView listNews;
    ProgressBar loader;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            olahraga.DownloadNews newsTask = new olahraga.DownloadNews();
            newsTask.execute();
        } else {
        ...
        teknologi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent teknologiIntent = new Intent(olahraga.this, teknologi.class);
        ...
        kesehatan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent kesehatanIntent = new Intent(olahraga.this, kesehatan.class);
        ...
        bisnis.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent bisnisIntent = new Intent(olahraga.this, bisnis.class);
    ...
    public void submitLapor(View view) {
        Intent intent = new Intent(olahraga.this, form_lapor.class);
    ...
    class DownloadNews extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String xml) {
            ...
            if(xml.length()>10){ // Just checking if not empty
                ...
                ListNewsAdapter adapter = new ListNewsAdapter(olahraga.this, dataList);
                listNews.setAdapter(adapter);

                listNews.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    public void onItemClick(AdapterView<?> parent, View view,
                                            int position, long id) {
                        Intent i = new Intent(olahraga.this, DetailsActivity.class);
