...
public class MainActivity extends AppCompatActivity {
    ...
    String COUNTRY = "id"; // // ### CHANGE WITH YOUR NEWS SOURCES see newsapi.org ###
    ListView listNews;
    ProgressBar loader;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        teknologi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent teknologiIntent = new Intent(MainActivity.this, teknologi.class);
        ...
        kesehatan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent kesehatanIntent = new Intent(MainActivity.this, kesehatan.class);
        ...
        bisnis.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent bisnisIntent = new Intent(MainActivity.this, bisnis.class);
        ...
        olahraga.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent olahragaIntent = new Intent(MainActivity.this, olahraga.class);
    ...
    public void submitLapor(View view) {
        Intent intent = new Intent(MainActivity.this, form_lapor.class);
