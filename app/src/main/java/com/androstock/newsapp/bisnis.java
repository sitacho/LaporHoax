...
public class bisnis extends AppCompatActivity {
    ...
    String CATEGORY = "business"; // // ### CHANGE WITH YOUR NEWS SOURCES see newsapi.org ###
    ListView listNews;
    ProgressBar loader;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            bisnis.DownloadNews newsTask = new bisnis.DownloadNews();
            newsTask.execute();
        } else {
        ...
        teknologi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent teknologiIntent = new Intent(bisnis.this, teknologi.class);
        ...
        kesehatan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent kesehatanIntent = new Intent(bisnis.this, kesehatan.class);
        ...
        olahraga.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent olahragaIntent = new Intent(bisnis.this, olahraga.class);
    ...
    public void submitLapor(View view) {
        Intent intent = new Intent(bisnis.this, form_lapor.class);
    ...
    class DownloadNews extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String xml) {
            ...
            if(xml.length()>10){ // Just checking if not empty
                ...
                ListNewsAdapter adapter = new ListNewsAdapter(bisnis.this, dataList);
                listNews.setAdapter(adapter);

                listNews.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    public void onItemClick(AdapterView<?> parent, View view,
                                            int position, long id) {
                        Intent i = new Intent(bisnis.this, DetailsActivity.class);
